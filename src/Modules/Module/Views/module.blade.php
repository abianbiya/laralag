...
<div class="row">
    ...
    <div class="col-3">
        {{ actionButton('module.create', title: $title) }}
    </div>
</div>
<div class="row mt-2">
    <div class="col-12">
    ...
    <table class="table table-hover table-nowrap mb-0">
        ...
        <tbody>
            ...
            <tr>
				...
				<td>
                    {{ actionButton('module.show', $item->id, $title) }}
                    {{ actionButton('module.edit', $item->id, $title) }}
                    ...
                    {{-- {{ customButton('module.blabla', $item->id, $title, 'bi bi-info-square', 'btn-outline-primary') }} --}}
                </td>
            </tr>
            @empty
            <tr>
