...
<div class="mt-2">
    <form action="{{ route('configitem.update', $config->id) }}" method="POST" class="form">
        @csrf
        @method('PATCH')
            ...
            <div class="col-md-6">
                <select name="config_group_id" class="form-control" required>
                    ...
                    @foreach($groups as $id => $nama)
                        <option value="{{ $id }}" {{ old('config_group_id', $config->config_group_id) == $id ? 'selected' : '' }}>{{ $nama }}</option>
                    @endforeach
                </select>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                <input type="text" name="config_name" class="form-control" value="{{ old('config_name', $config->config_name) }}">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                <textarea name="default_value" class="form-control" rows="2">{{ old('default_value', $config->default_value) }}</textarea>
            ...
            <div class="col-md-6">
                <select name="form_type" class="form-control" id="form_type" required>
                    @foreach($formTypes as $value => $label)
                        <option value="{{ $value }}" {{ old('form_type', $config->form_type) == $value ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
        ...
        <div class="row mb-3" id="form_options_row">
            <div class="col-md-3 text-sm-start text-md-end pt-2">
                <label>Form Options</label>
            </div>
            <div class="col-md-6">
                @php
                    $existingOptions = old('form_options',
                        $config->form_options ? json_encode($config->form_options, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE) : ''
                    );
                @endphp
                <textarea name="form_options" class="form-control font-monospace" rows="5" placeholder='[{"label":"Pilihan 1","value":"1"}]'>{{ $existingOptions }}</textarea>
        ...
        {{-- Is Multiple --}}
        <div class="row mb-3" id="is_multiple_row">
            <div class="col-md-3 text-sm-start text-md-end pt-2">
                <label>Multiple Value</label>
            </div>
            <div class="col-md-6">
                <select name="is_multiple" class="form-control">
                    <option value="0" {{ old('is_multiple', $config->is_multiple) == '0' ? 'selected' : '' }}>Tidak</option>
                    <option value="1" {{ old('is_multiple', $config->is_multiple) == '1' ? 'selected' : '' }}>Ya</option>
                </select>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                <input type="text" name="form_label" class="form-control" value="{{ old('form_label', $config->form_label) }}">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                <input type="text" name="form_placeholder" class="form-control" value="{{ old('form_placeholder', $config->form_placeholder) }}">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                <input type="text" name="form_help" class="form-control" value="{{ old('form_help', $config->form_help) }}">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                <input type="text" name="validation_rules" class="form-control" value="{{ old('validation_rules', $config->validation_rules) }}" placeholder="contoh: required|max:255">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                <input type="number" name="urutan" class="form-control" value="{{ old('urutan', $config->urutan) }}">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                <select name="is_tampil" class="form-control">
                    <option value="1" {{ old('is_tampil', $config->is_tampil) == '1' ? 'selected' : '' }}>Ya</option>
                    <option value="0" {{ old('is_tampil', $config->is_tampil) == '0' ? 'selected' : '' }}>Tidak</option>
                </select>
        ...
        <div class="offset-md-3 ps-2">
            ...
            <a href="{{ route('config-group.show', $config->config_group_id) }}" class="btn btn-secondary btn-sm">Batal</a>
        </div>
    </form>
</div>
@endsection
