...
<div class="mt-2">
    <form action="{{ route('permissionrole.update', $permissionrole->id) }}" method="POST" class="form">
        @csrf @method('patch')
        @if(request()->get('back'))
        ...
        <div class="offset-md-3 ps-2">
            ...
            <a href="{{ route('permissionrole.index') }}" class="btn btn-secondary btn-sm">Batal</a>
        </div>
    </form>
</div>
@endsection
